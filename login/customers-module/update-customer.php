...
<form method="POST" action="processes/process.user.php?action=update">
        <div id="form-block-half">
            ...
            <input type="text" id="cust_fname" class="input" name="cust_fname" value="<?php echo $user->get_cust_fname($id);?>" placeholder="Your name..">

            <label for="cust_lname">Last Name</label>
            <input type="text" id="cust_lname" class="input" name="cust_lname" value="<?php echo $user->get_cust_lname($id);?>" placeholder="Your last name..">
