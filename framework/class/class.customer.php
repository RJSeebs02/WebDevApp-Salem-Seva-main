...
class Customer{
	...
	public function update_customer($fname, $mname, $lname, $email, $address, $cnumber, $cust_id){
		...
		$q->execute(array(':cust_fname'=>$fname, ':cust_mname'=>$mname,':cust_lname'=>$lname,':cust_email'=>$email,':cust_address'=>$address, 'cust_cnumber'=>$cnumber, ':cust_id'=>$cust_id));
		return true;
	}
